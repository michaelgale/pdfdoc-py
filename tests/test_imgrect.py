...
def test_imgrect_init():
    t1 = ImageRect(10, 2, "./tests/testfiles/test.png")
...
def test_imgrect_pos():
    t1 = ImageRect(10, 2, "./tests/testfiles/test.png", _test_dict)
...
def test_imgrect_render():
    c = canvas.Canvas(
        "./tests/testfiles/test_imgrect.pdf", pagesize=(8.5 * inch, 11.0 * inch)
    )
    c.saveState()
    ...
    t2 = ImageRect(1 * inch, 2 * inch, "./tests/testfiles/tall.png", _text_dict)
...
def test_list_presets():
    ld = LabelDoc(
        "./tests/testfiles/test_img_preset_list.pdf", style=AVERY_5260_LABEL_DOC_STYLE
    )
