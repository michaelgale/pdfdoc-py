...
def test_cmykgrid():
    ...
    cg = CMYKGrid(1.75 * inch, 2.5 * inch, rows=11, cols=9)
    cg.label_style.set_with_dict(
        {
            "font-size": 7,
            "border-width": 0.5,
    ...
    cg.top_left = 0.5 * inch, 10 * inch
    cg.top_left_cmyk = (0.02, 0, 0, 0)
    cg.col_channel = "M"
    cg.set_col_range(0.14, 0.3)
    cg.row_channel = "Y"
    cg.set_row_range(0.5, 0.9)
    cg.draw_in_canvas(c)

    cg.top_left = 2.75 * inch, 10 * inch
    cg.top_left_cmyk = (0.06, 0, 0, 0)
    cg.col_channel = "M"
    cg.set_col_range(0.14, 0.3)
    cg.row_channel = "Y"
    cg.set_row_range(0.5, 0.9)
    ...
    cg.top_left = 5.0 * inch, 10 * inch
    cg.top_left_cmyk = (0.10, 0, 0, 0)
    cg.col_channel = "M"
    cg.set_col_range(0.14, 0.3)
    cg.row_channel = "Y"
    cg.set_row_range(0.5, 0.9)
